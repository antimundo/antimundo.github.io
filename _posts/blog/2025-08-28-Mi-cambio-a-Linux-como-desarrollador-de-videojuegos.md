---
layout: post
title: Mi cambio a Linux como desarrollador de videojuegos
teaser: /assets/images/teaser/mi-cambio-a-linux.jpg
categories: blog
---
...
**😕 Publicidad de OneDrive en el explorador de archivos de Windows**.
![Publicidad de OneDrive en el explorador de archivos de Windows](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-ad-1.jpg)

**😕 Publicidad en la barra de búsqueda de Windows**.
![Publicidad en la barra de búsqueda de Windows](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-ad-2.png)

**😕 Publicidad a pantalla completa de Microsoft Edge que aparece a veces al abrir Windows**. Este me parece especialmente insultante porque además usa [patrones oscuros](https://es.wikipedia.org/wiki/Dark_pattern) para intentar engañarte para que quites tu navegador actual y uses Microsoft Edge.
![Publicidad en la barra de búsqueda de Windows](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-ad-3.jpg)

**😕 Si buscas algún otro navegador como "Firefox" en la barra de Windows, Windows te muestra publicidad de Microsoft Edge...**
![Buscador de Windows donde el usuario busca "Firefox" y aparece un anuncio de "Microsoft Edge"](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-ad-edge.png)

**😕 Publicidad de Microsoft Edge que aparece de repente en la barra de tareas de Windows cuando estás usando otro navegador**
![Publicidad de Microsoft Edge en la barra de tareas de Windows](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-ad-4.jpg)

**😕 Publicidad de Microsoft Edge cuando vas a instalarte algún otro navegador como Google Chrome o Firefox**
![Publicidad de Microsoft Edge en la barra de tareas de Windows](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-ad-chrome.jpg)
...
Windows está lleno de programas como _OneDrive_, _OneNote_, _Xbox App_, _Microsoft Edge_, _BingSports_, _BingWeather_ y demás software que instala sin tu permiso.
...
Y uno pensaría _-pues simplemente no actualices Windows-_ bueno verás... NO PUEDES NO ACTUALIZAR WINDOWS, Windows se actualizará sin tu permiso quieras o no, no hay opción para detener esto. La única manera de detenerlo es mirarte un tutorial y cambiar unas opciones super ofuscada en el _Registory Editor_ que de todas formas Windows acaba reseteando tras un par de reboots, y Windows se actualizará igualmente.
...
- Suelo dejar el sistema operativo como viene por defecto, no suelo cambiar casi ninguna configuración ni hago nada extraño.
- Nunca instalo software pirata, ni de sitios extraños.

Entonces, si no hago nada fuera de lo común, no puedo comprender cómo es posible que, desde 2017 que tengo mi actual PC:
- He tenido por lo menos un **pantallazo azul de la muerte** al mes: Cuando a lo mejor estaba viendo un vídeo en YouTube sin hacer absolutamente nada más, ni tener ningún otro programa abierto. Y de repente sin venir a cuento 💥 Pantallazo azul de Windows. 💥
- He tenido por lo menos tres **fallos catastróficos que me han obligado a formatear**: Un día cualquiera Windows decidía actualizarse y al terminar de hacerlo 💥 Windows ya no funciona, toca formatear. 💥

![Un dibujo de un tipo frustrado en un ordenador](/assets/images/posts/2025-08-28-mi-cambio-a-linux/frustrated.png)
...
![Barra de búsqueda en Windows 10](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-search.jpg)
...
![CMD de Windows](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-cmd.jpg)
...
![Terminal de Linux y un dibujo de un tipo sacando músculo con unas gafas de sol](/assets/images/posts/2025-08-28-mi-cambio-a-linux/cmd.jpg)
...
**Instalar software en Linux Mint** es muy cómodo, si quiero instalar _Firefox_ escribo `sudo apt install firefox` y... FIN, no hay pasos adicionales.

Y si no te gusta el terminal, en Linux Mint hay una bonita interfaz gráfica para instalar software.

![Software Manager de Linux Mint](/assets/images/posts/2025-08-28-mi-cambio-a-linux/linux-software.png)
...
- En la Microsoft Store falta mucho software.
- Es una pesadilla para la privacidad: Requiere una cuenta de Microsoft y que registren qué aplicaciones instalas y desinstalas, y todo lo que haces.
- Hay muchísimás aplicaciones basura, o de cuentas maliciosas. Por ejemplo si buscas descargar la aplicación _VLC_ en la Microsoft Store aparecen resultados que no son de los desarrolladores oficiales.

![Aplicaciones falsas de VLC en la Microsoft Store](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-fake-apps.jpg)

#### 1.6.1.B: Descargarlo de la web oficial

Esta opción es horrible porque:
- Debes buscar la página web oficial, con el riesgo de equivocarte. Y a lo mejor tu eres muy listo, pero para la mayoría de usuarios es fácil equivocarse cuando al buscar en Google no siempre aparece la web oficial en el primer resultado:

![Busco en Google "Inkscape" y los primeros resultados son mierdas que no me interesan, la web oficial de Inkscape aparece más abajo en la búsqueda.](/assets/images/posts/2025-08-28-mi-cambio-a-linux/inkscape.jpg)

- Después de llegar a la web, debes buscar en esa web el botón de _desargar_ el instalador.
- Después debes ejecutar, y seguir los pasos del instalador: _continuar, continuar, continuar..._ leyendo bien lo que pone no vaya a ser que el instalador te instale software basura adicional que no quieres o te active alguna opción que no querías.
...
1. Abrir la aplicación que tiene Windows para desinstalar software, que hay dos, una en el _Panel de Control_, y otra en _Configuración_. En ocasiones hay software que SOLO aparecerá listado en el _Panel de Control_ y otras veces que SOLO aparecerá listado en _Configuración_. Así que a veces toca perder el tiempo buscando a ver dónde está la maldita aplicación que quieres eliminar.
2. Buscar el programa que quieres desinstalar de una lista.

![Desinstalador de Windows](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-uninstall.jpg)

3. A menudo también aparecerá un _wizard_ de desinstalación.
...
- Un banner para ver la temperatura, publicidad, y demás chorradas.
- Microsoft está obligando con cada vez más firmeza a tener que conectarte a internet y crear una cuenta de Microsoft para usar Windows, cuenta a la que se vincula toda la actividad de tu PC.
- Windows Recall con una IA grabando y analizando mi pantalla.
- Aplicaciones de IA que no quiero ni he pedido, como un chat integrado del LLM de microsoft.

![Microsoft Copilot ahora está integrado en Windows 11](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-copilot.jpg)
...
![Barra de búsqueda en Windows 10](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-ad-w11.png)

Bueno, pues resulta que NO PUEDO actualizar a Windows 11 porque mi PC al ser del 2017 no cumple ciertos requisitos de hardware. _(Se que hay triquiñuelas que puedes hacer para actualizar a Windows 11 aunque no cumplas los requisitos de hardware, pero Microsoft va poco a poco parcheando esas triquiñuelas y puede llegar a ser un tostón actualizar)_.
...
![Barra de búsqueda en Windows 10](/assets/images/posts/2025-08-28-mi-cambio-a-linux/windows-recycle.png)
...
Hacía años que tenía la idea de pasarme a Linux, y hace años que uso cada vez más software libre: _LibreOffice_, _Krita_, _OBS_, _Blender_, _Inkscape_, _Godot_, _Firefox_, _Kdenlive_...

Por lo que mi transición a Linux ha sido facilísima, no hay ningún programa que heche en falta en Linux.

![Collage del pinguino de Linux con logotipos de distintas distribuciones de Linux](/assets/images/posts/2025-08-28-mi-cambio-a-linux/gnu-linux-distro-logos.png)

### 2.1 Linux me hace trabajar rapidísimo

No me quiero repetir porque ya lo expliqué en apartados anteriores pero:
- En Linux puedes instalar/desinstalar/actualizar aplicaciones rapidísimo.
- Todo carga rapidísimo.
- Nunca aparece publicidad ni nada que te distraiga.
- No ocurre nada sin mi permiso, no se instalan ni actualizan cosas solas.

#### 2.1.1 El terminal mola 👍

El terminal tiene mil comandos turbo útiles:
- Poner todos los nombres de los archivos de un directorio en minúsculas: `rename 'y/A-Z/a-z/' *`
- Eliminar todos los archivos _.png_: `rm *.png`
- Buscar todos los archivos _.txt_ que hay en mi directorio y subdirectorios: `find . -name "*.txt"`

La respuesta natural al ver esto es pensar _-¿pero para qué necesitaría yo algo así como eliminar todos los archivos .png?-_, naturalmente si no usas el terminal ni se te pasan estas cosas por la cabeza, pero una vez lo usas, es como desbloquear un poder arcano que te da la habilidad de tener control absoluto sobre tu PC y trabajar cómoda y ágilmente.

_No usar el terminal_ VS _usar el terminal_, es como una persona que copia y pega documentos haciendo click derecho y seleccionando "copiar" y luego click derecho en otro sitio y seleccionando "pegar" VS otra persona que usa los atajos de teclado CTRL+C y CTRL+V. Si no sabes que existen puedes vivir sin los atajos de teclado, pero una vez los usas te das cuenta de que trabajas mil veces más rápido.
...
![Icono de mi aplicación Backup Mint](/assets/images/posts/2025-08-28-mi-cambio-a-linux/backup-mint.png)
...
![Un dibujo de un muñeco levantando a Godot como algo glorioso](/assets/images/teaser/miniatura-godot-glory.jpg)
...
Pero, la mayoría de desarrolladores de videojuegos solo dan soporte a Windows, y algunos videojuegos, especialmente videojuegos online con anticheat como _League Of Legends_, _Valorant_, _Fortnite_, _Warzone_ directamente no funcionan en Linux.

Aun así hay muchos videojuegos que funcionan perfectamente en Linux, de momento he jugado sin problemas al _Doom Eternal_, _Counter Strike 2_, _Brotato_, _Sniper Elite 4_, _Team Fortress 2_, _Portal_, _Minecraft_, _Luanti_.

![Personaje mirando unas montañas al horizonte al atardecer en el videojuego Veloren, se observan unas montañas](/assets/images/posts/2025-08-28-mi-cambio-a-linux/veloren.jpg)
...
![Un dibujo de Tux el pingüino de Linux huyendo en un kart de un monstruo Microsoft](/assets/images/teaser/mi-cambio-a-linux.jpg)

...
date = 2020-01-07
teaser = '/images/teaser/miniatura-nvidia.jpg'
+++
...
| CONFIGURACIÓN DEL PC | CONFIGURACIÓN DEL STREAM |
|-|-|
| CPU: i5 7600k\ GPU: GTX 1070 8gb\ RAM: 16 gb a 2400Mhz  | Programa: Streamlabs OBS\ Resolución: 1080p\ FPS: 60\ Bitrate: 3000\ Codec NVEC (new) |

Configuración de las pruebas, jugando al CSGO en 1080p, con los gráficos en alto, en el mapa de Dust2.

| FPS SIN LÍMITE | LIMITADOS A 60FPS |
|-|-|
| CPU: 90%\ GPU: 90%\ RAM: 42% | CPU: 20%\ GPU: 19%\ RAM: 24% |

Consumo del juego sin hacer stream

| FPS SIN LÍMITE | LIMITADOS A 60FPS |
|-|-|
| CPU: 80%\ GPU: 80%\ RAM: 40% | CPU: 18%\ GPU: 18%\ RAM: 22% |
